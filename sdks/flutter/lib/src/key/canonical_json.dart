...
Object? normalizeCanonicalValue(Object? value) {
  ...
  if (value is num) {
    if (!value.isFinite) {
      throw ArgumentError('Non-finite numbers are not allowed in canonical JSON');
    }
    if (value == 0) return 0;
    return value;
  }
  ...
  throw ArgumentError('Unsupported value type in canonical JSON: ${value.runtimeType}');
}
